...
const ScrollAnimationSection = () => {
  ...
  const itemTransforms = contentData.map((_, index) => {
    ...
    const transitionDuration = 0.15; // 15% of each item's scroll time for transitions // o.25 looks good
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="h-screen bg-white flex items-center justify-center">
        <h2 className="text-4xl font-bold text-gray-800">Scroll down to see the content animation</h2>
      </div>
