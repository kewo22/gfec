...
export default function Page() {
  return (
    <section className="mb-20 lg:mt-10">
      {/* mt-10 mb-20 sm:mb-32  */}
      <div className="px-10 lg:px-24 xl:px-52">
        <h1 className="text-2xl font-bold leading-normal tracking-tight text-center sm:text-left text-gray-900 my-5">
          Privacy Policy for Gordon Foreign Education Consultancy (Pvt) Ltd
        </h1>

        <p className="font-light text-base text-gray-900 text-justify">
          At Gordon Foreign Education Consultancy , accessible from
          www.gfeconsultancy.com , one of our main priorities is the privacy of
          our visitors. This Privacy Policy document contains types of
          information that is collected and recorded by Gordon Foreign Education
        ...
        <p className="font-light text-base text-gray-900 text-justify">
          ...
          shared and/or collect in Gordon Foreign Education Consultancy . This
        ...
        <p className="font-light text-base text-gray-900 text-justify">
          ...
          advertising partners of Gordon Foreign Education Consultancy .
        </p>
        ...
        <p className="font-light text-base text-gray-900 text-justify">
          Note that Gordon Foreign Education Consultancy has no access to or
        ...
        <p className="font-light text-base text-gray-900 text-justify">
          Gordon Foreign Education Consultancy does not knowingly collect any
